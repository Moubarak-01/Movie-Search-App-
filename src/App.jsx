...
//
// const API_KEY = "35cc732e3ae2aa4243534bb961a615fb";
//
// const API_OPTIONS = {
//   method: 'GET',
//   headers: {
...
const App = () => {
  ...
  return (
    <main>
      ...
      <div className="wrapper">
        <header>
          <img src="../public/logo.png" alt="Logo" className="size-20 mt-0.5"/>
          <img className="size-auto" src="../public/hero.png" alt="Hero Banner" />
